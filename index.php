...
<body style="background-color:black;">
    ...
    <footer class="page-footer font-small">
        ...
        <!-- Copyright -->
        <div class="footer-copyright text-center py-1" style="color:white;">©2022Feb Round:
            Mohamed Adel Fahmy<br><br> The Sparks Foundation Web Design&Web Development Intenrship
        </div>
